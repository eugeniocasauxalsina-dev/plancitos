...
export default function FavoritosPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      {favorites.length === 0 ? (
        <div className="mt-8 rounded-2xl border border-dashed border-neutral-300 py-16 text-center">
          <p className="text-4xl">🤍</p>
          <p className="mt-3 font-medium text-neutral-700">Todavía no guardaste favoritos.</p>
